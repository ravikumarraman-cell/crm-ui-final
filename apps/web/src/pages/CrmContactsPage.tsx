...
export function CrmContactsPage() {
  ...
  // Selected contact for detail pane (Screenshot 2)
  ...
  const handleUpdateContact = async (updates: Partial<Contact>) => {
    ...
    await updateContactApi(selectedContactId, updates);
    refetchDetail();
    refetch();
  };
  ...
  return (
    <div className="oneness-app">
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          {selectedContactId && detailContact ? (
            /* Screenshot 2: Contact Detail View */
            <ContactDetailPane
            ...
            /* Screenshot 1: Contacts List View */
            <>
              {/* Header & Tabs */}
      ...
      <BreezeAiModal
        ...
        selectedContactName={detailContact?.name}
      />
    </div>
  );
}
